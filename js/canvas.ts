...
function setColors(colorPalette: number) {
    orangeCol = colorPalette === 2 ? [0x90, 0x90, 0x90] : colorPalette === 3 ? [0x94, 0x94, 0x94] : colorPalette ? [0xff, 0x65, 0x00] : [0xfc, 0x4d, 0x14]; //[0xff, 0x6a, 0x3c];
    greenCol = colorPalette === 2  ? [0xa0, 0xa0, 0xa0] : colorPalette === 3 ? [0x5c, 0x5c, 0x5c] : colorPalette ? [0x00, 0xff, 0x00] : [0x48, 0xf2, 0x03]; //[0x14, 0xf5, 0x3c];
    blueCol = colorPalette === 2   ? [0xc0, 0xc0, 0xc0] : colorPalette === 3 ? [0x80, 0x80, 0x80] : colorPalette ? [0x09, 0xa9, 0xdd] : [0x14, 0xcf, 0xfd]; //[0x14, 0xcf, 0xfd];
    violetCol = colorPalette === 2 ? [0xb0, 0xb0, 0xb0] : colorPalette === 3 ? [0xac, 0xac, 0xac] : colorPalette ? [0xc9, 0x39, 0xc7] : [0xe9, 0x44, 0xf4]; //[0xff, 0x44, 0xfd];
    whiteCol = colorPalette === 2  ? [0xff, 0xff, 0xff] : colorPalette === 3 ? [0xff, 0xff, 0xff] : colorPalette ? [0xff, 0xff, 0xff] : [0xff, 0xff, 0xff]; //[0xff, 0xff, 0xff];
    blackCol = colorPalette === 2  ? [0x00, 0x00, 0x00] : colorPalette === 3 ? [0x00, 0x00, 0x00] : colorPalette ? [0x00, 0x00, 0x00] : [0x00, 0x00, 0x00]; //[0x00, 0x00, 0x00];
...
function get16Colors(colorPalette: number): Color[] {
    return [
        colorPalette === 2 ? [0x00, 0x00, 0x00] : colorPalette === 3 ? [0x00, 0x00, 0x00] : colorPalette ? [0x00, 0x00, 0x00] : [0x00, 0x00, 0x00], //[0x00, 0x00, 0x00], // 0x0 black
        colorPalette === 2 ? [0x80, 0x80, 0x80] : colorPalette === 3 ? [0x80, 0x80, 0x80] : colorPalette ? [0xdd, 0x00, 0x33] : [0x9b, 0x0c, 0x86], //[0xe3, 0x1e, 0x60], // 0x1 deep red
        colorPalette === 2 ? [0x78, 0x78, 0x78] : colorPalette === 3 ? [0x85, 0x85, 0x85] : colorPalette ? [0x00, 0x00, 0x99] : [0x21, 0x33, 0xd4], //[0x60, 0x4e, 0xbd], // 0x2 dark blue
        colorPalette === 2 ? [0xa8, 0xa8, 0xa8] : colorPalette === 3 ? [0xa1, 0xa1, 0xa1] : colorPalette ? [0xdd, 0x00, 0xdd] : [0xbb, 0x37, 0xff], //[0xff, 0x44, 0xfd], // 0x3 purple
        colorPalette === 2 ? [0x88, 0x88, 0x88] : colorPalette === 3 ? [0x51, 0x51, 0x51] : colorPalette ? [0x00, 0x77, 0x00] : [0x00, 0x77, 0x0c], //[0x00, 0xa3, 0x60], // 0x4 dark green
        colorPalette === 2 ? [0x99, 0x99, 0x99] : colorPalette === 3 ? [0x9c, 0x9c, 0x9c] : colorPalette ? [0x66, 0x66, 0x66] : [0x7b, 0x80, 0x7d], //[0x9c, 0x9c, 0x9c], // 0x5 dark gray
        colorPalette === 2 ? [0xb8, 0xb8, 0xb8] : colorPalette === 3 ? [0x88, 0x88, 0x88] : colorPalette ? [0x22, 0x22, 0xff] : [0x06, 0xa9, 0xdf], //[0x14, 0xcf, 0xfd], // 0x6 medium blue
        colorPalette === 2 ? [0xd4, 0xd4, 0xd4] : colorPalette === 3 ? [0xe1, 0xe1, 0xe1] : colorPalette ? [0x66, 0xaa, 0xff] : [0x9b, 0xad, 0xff], //[0xd0, 0xc3, 0xff], // 0x7 light blue
        colorPalette === 2 ? [0x66, 0x66, 0x66] : colorPalette === 3 ? [0x3a, 0x3a, 0x3a] : colorPalette ? [0x88, 0x55, 0x22] : [0x71, 0x6d, 0x03], //[0x60, 0x72, 0x03], // 0x8 brown
        colorPalette === 2 ? [0xa0, 0xa0, 0xa0] : colorPalette === 3 ? [0x9d, 0x9d, 0x9d] : colorPalette ? [0xff, 0x66, 0x00] : [0xf9, 0x54, 0x1d], //[0xff, 0x6a, 0x3c], // 0x9 orange
        colorPalette === 2 ? [0x99, 0x99, 0x99] : colorPalette === 3 ? [0x9c, 0x9c, 0x9c] : colorPalette ? [0x99, 0x99, 0x99] : [0x7d, 0x7f, 0x81], //[0x9c, 0x9c, 0x9c], // 0xa light gray
        colorPalette === 2 ? [0xcc, 0xcc, 0xcc] : colorPalette === 3 ? [0xcf, 0xcf, 0xcf] : colorPalette ? [0xff, 0x99, 0x88] : [0xff, 0x8b, 0xea], //[0xff, 0xa0, 0xd0], // 0xb pink
        colorPalette === 2 ? [0xbb, 0xbb, 0xbb] : colorPalette === 3 ? [0x84, 0x84, 0x84] : colorPalette ? [0x00, 0xdd, 0x00] : [0x43, 0xc8, 0x00], //[0x14, 0xf5, 0x3c], // 0xc green
        colorPalette === 2 ? [0xee, 0xee, 0xee] : colorPalette === 3 ? [0xb5, 0xb5, 0xb5] : colorPalette ? [0xff, 0xff, 0x00] : [0xd0, 0xcf, 0x16], //[0xd0, 0xdd, 0x8d], // 0xd yellow
        colorPalette === 2 ? [0xdd, 0xdd, 0xdd] : colorPalette === 3 ? [0xb8, 0xb8, 0xb8] : colorPalette ? [0x00, 0xff, 0x99] : [0x5c, 0xf7, 0x88], //[0x72, 0xff, 0xd0], // 0xe aquamarine
        colorPalette === 2 ? [0xff, 0xff, 0xff] : colorPalette === 3 ? [0xff, 0xff, 0xff] : colorPalette ? [0xff, 0xff, 0xff] : [0xff, 0xff, 0xff]  //[0xff, 0xff, 0xff]  // 0xf white
    ];
}
