...
function setColors(colorPalette: number) {
    orangeCol = colorPalette === 2 ? [0x90, 0x90, 0x90] : colorPalette === 3 ? [0x94, 0x94, 0x94] : colorPalette ? [0xff, 0x65, 0x00] : [0xf6, 0x4d, 0x14]; //[0xff, 0x6a, 0x3c];
    greenCol = colorPalette === 2  ? [0xa0, 0xa0, 0xa0] : colorPalette === 3 ? [0x5c, 0x5c, 0x5c] : colorPalette ? [0x00, 0xff, 0x00] : [0x48, 0xd2, 0x03]; //[0x14, 0xf5, 0x3c];
    ...
    violetCol = colorPalette === 2 ? [0xb0, 0xb0, 0xb0] : colorPalette === 3 ? [0xac, 0xac, 0xac] : colorPalette ? [0xc9, 0x39, 0xc7] : [0xbd, 0x36, 0xff]; //[0xff, 0x44, 0xfd];
...
function get16Colors(colorPalette: number): Color[] {
    return [
        ...
        colorPalette === 2 ? [0x66, 0x66, 0x66] : colorPalette === 3 ? [0x3a, 0x3a, 0x3a] : colorPalette ? [0x88, 0x55, 0x22] : [0x61, 0x4d, 0x00], //[0x60, 0x72, 0x03], // 0x8 brown
