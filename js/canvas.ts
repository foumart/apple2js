...
function setColors(colorPalette: number) {
    orangeCol = colorPalette === 2 ? [0xea, 0x62, 0x2f] : colorPalette === 3 ? [0x94, 0x94, 0x94] : colorPalette ? [0xff, 0x65, 0x00] : [0xff, 0x6a, 0x3c];
    greenCol = colorPalette === 2  ? [0x00, 0xf5, 0x28] : colorPalette === 3 ? [0x5c, 0x5c, 0x5c] : colorPalette ? [0x00, 0xff, 0x00] : [0x14, 0xf5, 0x3c];
    blueCol = colorPalette === 2   ? [0x00, 0xcd, 0xff] : colorPalette === 3 ? [0x80, 0x80, 0x80] : colorPalette ? [0x09, 0x2a, 0xff] : [0x14, 0xcf, 0xfd];
...
function get16Colors(colorPalette: number): Color[] {
    return [
        ...
        colorPalette === 2 ? [0xe0, 0x05, 0x4d] : colorPalette === 3 ? [0x70, 0x70, 0x70] : colorPalette ? [0xdd, 0x00, 0x33] : [0xe3, 0x1e, 0x60], // 0x1 deep red
        colorPalette === 2 ? [0x50, 0x3c, 0xb8] : colorPalette === 3 ? [0x40, 0x40, 0x40] : colorPalette ? [0x00, 0x00, 0x99] : [0x60, 0x4e, 0xbd], // 0x2 dark blue
        colorPalette === 2 ? [0xff, 0x38, 0xff] : colorPalette === 3 ? [0xac, 0xac, 0xac] : colorPalette ? [0xdd, 0x00, 0xdd] : [0xff, 0x44, 0xfd], // 0x3 purple
        colorPalette === 2 ? [0x00, 0x8d, 0x42] : colorPalette === 3 ? [0x50, 0x50, 0x50] : colorPalette ? [0x00, 0x77, 0x00] : [0x00, 0xa3, 0x60], // 0x4 dark green
        colorPalette === 2 ? [0x99, 0x99, 0x99] : colorPalette === 3 ? [0x80, 0x80, 0x80] : colorPalette ? [0x66, 0x66, 0x66] : [0x9c, 0x9c, 0x9c], // 0x5 dark gray
        colorPalette === 2 ? [0x00, 0xcd, 0xff] : colorPalette === 3 ? [0x9c, 0x9c, 0x9c] : colorPalette ? [0x22, 0x22, 0xff] : [0x14, 0xcf, 0xfd], // 0x6 medium blue
        colorPalette === 2 ? [0xe6, 0xd8, 0xff] : colorPalette === 3 ? [0xb4, 0xb4, 0xb4] : colorPalette ? [0x66, 0xaa, 0xff] : [0xd0, 0xc3, 0xff], // 0x7 light blue
        colorPalette === 2 ? [0x3b, 0x50, 0x00] : colorPalette === 3 ? [0x5c, 0x5c, 0x5c] : colorPalette ? [0x88, 0x55, 0x22] : [0x60, 0x72, 0x03], // 0x8 brown
        colorPalette === 2 ? [0xff, 0x62, 0x2f] : colorPalette === 3 ? [0xa0, 0xa0, 0xa0] : colorPalette ? [0xff, 0x66, 0x00] : [0xff, 0x6a, 0x3c], // 0x9 orange
        colorPalette === 2 ? [0x99, 0x99, 0x99] : colorPalette === 3 ? [0x84, 0x84, 0x84] : colorPalette ? [0x99, 0x99, 0x99] : [0x9c, 0x9c, 0x9c], // 0xa light gray
        colorPalette === 2 ? [0xff, 0xab, 0xe0] : colorPalette === 3 ? [0xc0, 0xc0, 0xc0] : colorPalette ? [0xff, 0x99, 0x88] : [0xff, 0xa0, 0xd0], // 0xb pink
        colorPalette === 2 ? [0x00, 0xf5, 0x28] : colorPalette === 3 ? [0x80, 0x80, 0x80] : colorPalette ? [0x00, 0xdd, 0x00] : [0x14, 0xf5, 0x3c], // 0xc green
        colorPalette === 2 ? [0xd9, 0xe8, 0x90] : colorPalette === 3 ? [0xe8, 0xe8, 0xe8] : colorPalette ? [0xff, 0xff, 0x00] : [0xd0, 0xdd, 0x8d], // 0xd yellow
        colorPalette === 2 ? [0x73, 0xff, 0xda] : colorPalette === 3 ? [0xd4, 0xd4, 0xd4] : colorPalette ? [0x00, 0xff, 0x99] : [0x72, 0xff, 0xd0], // 0xe aquamarine
