...
function setColors(colorPalette: number) {
    orangeCol = colorPalette === 2 ? [0x90, 0x90, 0x90] : colorPalette === 3 ? [0x94, 0x94, 0x94] : colorPalette === 1 ? [0xff, 0x6a, 0x3c] : [0xff, 0xaa, 0x66];
    greenCol = colorPalette === 2  ? [0xa0, 0xa0, 0xa0] : colorPalette === 3 ? [0x5c, 0x5c, 0x5c] : colorPalette === 1 ? [0x14, 0xf5, 0x3c] : [0x88, 0xff, 0x66];
    blueCol = colorPalette === 2   ? [0xc0, 0xc0, 0xc0] : colorPalette === 3 ? [0x80, 0x80, 0x80] : colorPalette === 1 ? [0x14, 0xcf, 0xfd] : [0x66, 0xee, 0xff];
    violetCol = colorPalette === 2 ? [0xb0, 0xb0, 0xb0] : colorPalette === 3 ? [0xac, 0xac, 0xac] : colorPalette === 1 ? [0xff, 0x44, 0xfd] : [0xdd, 0x99, 0xff];
    whiteCol = [0xff, 0xff, 0xff];
    blackCol = [0x00, 0x00, 0x00];
